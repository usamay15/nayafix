      ...
      <AppShell
        ...
        seoContent={
          <div style={{ padding: '2rem 0', display: 'flex', flexDirection: 'column', gap: '3rem' }}>
            ...
            {/* How to Use Section */}
            <section className="bg-[var(--clr-surface)] p-8 rounded-2xl border border-[var(--clr-border)] relative overflow-hidden group hover:border-blue-400/30 transition-all duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                ...
                <div className="bg-[var(--clr-bg-2)] p-6 rounded-xl shadow-sm border border-[var(--clr-border)] transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-2 hover:border-blue-300 group/card relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-md shadow-blue-500/30">
                    ...
                    <h3 className="text-xl font-bold text-[var(--clr-text-1)]">Select Languages</h3>
                    <span className="text-4xl font-extrabold text-blue-500/10 absolute right-4 top-4 select-none">01</span>
                  </div>
                  <p className="text-[var(--clr-text-2)] leading-relaxed">Use the dropdowns at the top of the converter to choose your source and target languages. We support English, Urdu, Hindi, Roman Urdu, and Roman Hindi.</p>
                </div>
                ...
                <div className="bg-[var(--clr-bg-2)] p-6 rounded-xl shadow-sm border border-[var(--clr-border)] transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-2 hover:border-blue-300 group/card relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-[var(--clr-text-1)]">Enter Text</h3>
                    <span className="text-4xl font-extrabold text-blue-500/10 absolute right-4 top-4 select-none">02</span>
                  </div>
                  <p className="text-[var(--clr-text-2)] leading-relaxed">Type directly into the box, paste text, or drag-and-drop a `.txt`, `.docx`, or `.pdf` file. You can even use our built-in virtual keyboards!</p>
                </div>
                ...
                <div className="bg-[var(--clr-bg-2)] p-6 rounded-xl shadow-sm border border-[var(--clr-border)] transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-2 hover:border-blue-300 group/card relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-[var(--clr-text-1)]">Translate & Share</h3>
                    <span className="text-4xl font-extrabold text-blue-500/10 absolute right-4 top-4 select-none">03</span>
                  </div>
                  <p className="text-[var(--clr-text-2)] leading-relaxed">Click Convert! Once translated, you can instantly copy the text, download it as a file, share it to WhatsApp/Telegram, or save it to Favourites.</p>
                </div>
              </div>
            </section>
            ...
            <section className="pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Feature 1 */}
                <div className="p-6 border border-[var(--clr-border)] rounded-xl bg-[var(--clr-bg-2)] transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 hover:border-blue-300 group cursor-default">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="p-3 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-lg group-hover:scale-110 transition-transform shadow-md shadow-blue-500/30">
